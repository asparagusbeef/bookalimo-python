...
class TestEndToEndBookingFlow:
    ...
    @pytest.mark.asyncio
    async def test_complete_async_booking_flow(self, booking_locations, test_credit_card):
    ...
    def test_complete_sync_booking_flow(self, booking_locations, test_credit_card):
        ...
        pickup, dropoff = booking_locations
        credentials = Credentials.create("sync_integration_user", "sync_integration_password")
    ...
    async def test_reservation_management_flow(self):
        ...
        credentials = Credentials.create("reservation_mgmt_user", "reservation_mgmt_password")
    ...
    async def test_error_handling_throughout_flow(self, booking_locations):
        ...
        with respx.mock(base_url="https://sandbox.bookalimo.com") as respx_mock:
            ...
            respx_mock.post("/booking/details/").mock(
                return_value=httpx.Response(400, json={"error": "Invalid car class", "code": "INVALID_CAR_CLASS"})
            )
...
class TestGooglePlacesIntegration:
    ...
    def test_places_integration_with_booking_flow(self, test_credit_card):
        ...
        credentials = Credentials.create("places_integration_user", "places_integration_password")
...
import asyncio  # Add this import for the business trip test