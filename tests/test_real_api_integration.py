...
from bookalimo.schemas.booking import Location, LocationType, RateType
...
class TestRealBookalimoAPI:
    ...
    @pytest.fixture
    def real_dropoff_location(self):
